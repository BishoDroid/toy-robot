/**
 * Used to read and validate instructions from a file
 */

var fs = require('fs');

/**
 * InstructionsReader constructor
 * @constructor
 */
var InstructionsReader = function() {};
 ...
 */
InstructionsReader.prototype.readInputFile = function(fileName, cb) {
 ...
 * @param {Function} cb Callback function
 */
InstructionsReader.prototype.validateInput = function(argString, cb) {
...
module.exports = InstructionsReader;